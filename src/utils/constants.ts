...
import franchiseDark from "@/app/images/img2-1.jpg";
import solutionsDark from "@/app/images/img2-2.jpg";
import districtDark from "@/app/images/img2-3.jpg";
import contractDark from "@/app/images/img2-4.jpg";
import paratroopersDark from "@/app/images/img2-5.jpg";
...
export const sliderItemsDark: { src: string | StaticImageData, author: string, title: string, topic: string, description: string, buttonLink: string}[] = [
    {   src: franchiseDark,
        author: 'Отдел по работе с МО',
        title: 'направление',
        topic: 'ФРАНЧАЙЗИНГ',
...
export const thumbnailItemsDark: { src: string | StaticImageData, title: string, description: string }[] = [
    {   src: franchiseDark,
        title: 'ФРАНЧАЙЗИНГ',
        description: 'Подробнее', },
    {   src: contractDark,
