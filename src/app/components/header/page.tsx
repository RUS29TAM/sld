    ...
    return (
        <header className={`${styles.header} ${isDarkTheme ? styles.darkTheme : styles.lightTheme}`}>
            <nav>
                    ...
                    <Link className={`${styles.a} ${isDarkTheme ? styles.darkTheme : styles.lightTheme}`} href={'/pages/plug'}>КОНТАКТЫ</Link>
                    <Link className={`${styles.a} ${isDarkTheme ? styles.darkTheme : styles.lightTheme}`} href={'/pages/plug'}>ИНФО</Link>
                </nav>
