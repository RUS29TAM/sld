            ...
            <div className={styles.timelineContainer}>
                ...
                <div className={styles.timelinePoint}>
                    <i className={`${styles.faSolid} ${styles.faCopyright}`}>
                        <div onClick={() => handleClickNum(<div className={styles.description}><p>Экономический
                            ...
                            партнеров.</p>
                            <button>Далее</button>
                        </div>)} className={styles.faIcons}>2
                        </div>
                    </i>
                    <div className={styles.popup}>
                ...
                <div className={styles.timelinePoint}>
                    <i className={`${styles.faSolid} ${styles.faBullseye}`}>
                        <div onClick={() => handleClickNum(<div className={styles.description}><p>Время переговоров на
                            словах франчайзер может много всего обещать, но обращать внимание
                            ...
                            этапе сотрудничества и обязательствах сторон по всем аспектам.</p>
                            <button>Далее</button>
                        </div>)} className={styles.faIcons}>3
                        </div>
                    </i>
                    <div className={styles.popup}>
                ...
                <div className={styles.timelinePoint}>
                    <i className={`${styles.faSolid} ${styles.faCompass}`}>
                        <div onClick={() => handleClickNum(<div className={styles.description}><p>То, как франчайзер
                            отвечает на Ваши вопросы, показывает его отношение к своим партнерам и
                            готовность помогать на стадии запуска Вашего бизнеса</p>
                            <button>Далее</button>
                        </div>)} className={styles.faIcons}>4
                        </div>
                    </i>
                    <div className={styles.popup}>
                ...
                <div className={styles.timelinePoint}>
                    <i className={`${styles.faSolid} ${styles.faFaceGrinBeamSweat}`}>
                        <div
                            onClick={() => handleClickNum(<div className={styles.description}><p>Необходимо быть готовым
                                к любым жизненным ситуациям и понимать, на что франчайзер имеет
                                право в рамках договора, а в чем Вы ему можете отказать. И наоборот, что франчайзер
                                может
                                контролировать в Вашем бизнесе и за что он может Вас штрафовать и наказывать, а за что
                                может
                                даже отозвать франшизу.</p>
                                <button>Далее</button>
                            </div>)} className={styles.faIcons}>5
                        </div>
                    </i>
                    <div className={styles.popup}>
