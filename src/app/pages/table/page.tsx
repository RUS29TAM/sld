...
const images = [
    ...
    { url: 'https://play-lh.googleusercontent.com/S315zKj_Ogakz2HEQRzGHaletmEkv0FkCqcmKQrSmiLgM0r4LzKIebF_HNOdD1-3V9ei=h500', title: 'Сеть ресторанов быстрого обслуживания', description1: ' STARFOODS', description2: <a className={styles.link} target={"_blank"} href={'https://xn--80ai9acdcjh.xn--p1ai/franshise'}>Посетить сайт</a>},
